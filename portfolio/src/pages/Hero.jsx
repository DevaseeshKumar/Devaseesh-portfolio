...
import profileImage from "../assets/download.jpg"; // make sure your image is inside src/assets/
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center w-full max-w-7xl mx-auto">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-8">
            <a
              href="#"
              className="text-blue-600 dark:text-blue-400 hover:text-blue-400 dark:hover:text-blue-200 text-xl"
            >
        ...
        <div className="flex justify-center">
          <div className="relative group">
            <img
              src={profileImage}
              alt="Profile"
              className="w-72 h-72 object-cover rounded-full shadow-2xl border-4 border-blue-500 
                         transition-transform duration-500 group-hover:scale-105 animate-float"
            />
